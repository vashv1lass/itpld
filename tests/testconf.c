...
itpld_test_registry_entry_t const ITPLD_TEST_REGISTRY[] = {
	...
	{ .name = "elf_read_ubyte",      .func = itpld_elf_read_ubyte_test      },
	{ .name = "elf_read_utwobyte",   .func = itpld_elf_read_utwobyte_test   },
	{ .name = "elf_read_fourbyte",   .func = itpld_elf_read_fourbyte_test   },
	{ .name = "elf_read_ufourbyte",  .func = itpld_elf_read_ufourbyte_test  },
	{ .name = "elf_read_eightbyte",  .func = itpld_elf_read_eightbyte_test  },
	{ .name = "elf_read_ueightbyte", .func = itpld_elf_read_ueightbyte_test },
};
/* clang-format on */
